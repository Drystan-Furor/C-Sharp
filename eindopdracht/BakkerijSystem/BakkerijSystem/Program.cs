...
namespace BakkerijSystem
{
    ...
    static class Program
    {
        static void Main(string[]args)
        {
            ...
            Console.WriteLine("Vul om te beginnen je functie in, zoals deze bij u bekend is.");
            ...
            /*
            else (functieGebruiker == "Manager" || "Inkoper01" || "Inkoper02" || "Verkoper01" || "Verkoper02" || "Verkoper03");
            {
                Console.WriteLine("U heeft helaas een onbekende functie gebruikt.");//verkeerde functie ingevoerd
            }*/
        }
    }
}